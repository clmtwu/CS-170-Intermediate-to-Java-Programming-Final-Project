...
Brief Description: This class is the main class that act as the main menu of the game and calls the other classes. It creates the menu frame and the other classes
can return to this class once done.
*********************************************************************************/ 
package stuff;
	...
	public void FramePrompt() { //the method for 
        ...
        LEADERBOARD.addActionListener((java.awt.event.ActionListener) new ActionListener() { //creating action listener for submit button
            public void actionPerformed(ActionEvent e){ //method of execution
                ...
                Frame.setVisible(false); //you can't see me!
                Frame.dispose(); //Destroy the JFrame object
                if (Scores.ScoreboardArray.size() < 1 ) {
                JOptionPane.showMessageDialog(f, "No score detected");
                sound.stop();
                }else
                sound.stop();//stops current music
                try {
