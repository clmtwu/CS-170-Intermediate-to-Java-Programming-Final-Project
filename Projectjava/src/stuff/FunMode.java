...
Brief Description:  This class creates the frame for the FunMode where the user has to enter the alphabet backwards. It has the keyboard from alphabet and runs
the arraylist from there. This class is called when the user hits the Funmode button on the main menu.
*********************************************************************************/ 
package stuff;
import javax.swing.*;
